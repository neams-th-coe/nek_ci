...
# NekRS ciTestErrors() regression tolerance.
CI_EPS = 5.0E-2

# NekRS ciMode = 7 reference errors.
REF_VOL_ERROR     = 0.2465620E-06
REF_YPISTON_ERROR = 0.2465620E-05
REF_TEMP_ERROR    = 0.3500000E-05
...
[Postprocessors]
  ...
  # Reconstruct the piston coordinate from the computed volume.
  [ypiston]
  ...
  # Additional Cardinal-only moving-boundary diagnostic.
  [termV_x]
  ...
  # Available ciMode = 7 checks plus the Cardinal-only termV check.
  #
  ...
  #   average CVODE RHS/linear iteration count
  [pass]
    type = ParsedPostprocessor
