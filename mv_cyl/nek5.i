...
# ciMode = 5 rotates the case by 0.5 radians.
P_ROT = 0.5
...
# NekRS ciMode = 5 reference errors.
...
[Functions]
  ...
  # Do not project this by cos(P_ROT), because the CI reference error is
  # defined for the axial piston coordinate.
  [ypex]
    type = ParsedFunction
...
[Postprocessors]
  ...
  # Available ciMode = 5 checks plus the Cardinal-only termV check.
  #
